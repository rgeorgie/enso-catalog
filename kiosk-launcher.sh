...
CHROME_FLAGS="--no-default-browser-check --no-first-run --password-store=basic --disable-features=CredentialManagement --disable-extensions --disable-component-update --no-sandbox"
