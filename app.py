...
translations = {
    ...
    "bg": {
        ...
        "Unpaid": "Unpaid",
        "All": "All",
        "Search name / category": "Search name / category",
        ...
        "Due": "Due",
        "No monthly fee configured for this player.": "No monthly fee configured for this player.",
        ...
        "Unpaid": "Неплатено",
        "All": "Всички",
        "Search name / category": "Търси по име / категория",
        "Back to event": "Обратно към събитието",
        ...
        "Actions": "Действия",
        "Delete": "Изтрий",
        "Add registrations": "Добави записвания",
        ...
        "Due": "Дължимо",
        "No monthly fee configured for this player.": "Няма зададена месечна такса за този състезател.",
        ...
        "ENSO Profile URL": "ENSО профил (URL)",
        "Open": "Отвори",
